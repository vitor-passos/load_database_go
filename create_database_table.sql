...
\c client;
create table client_infos (id serial primary key, cpf text, private bool, imcompleto bool, data_da_ultima_compra text, ticket_medio decimal, ticket_da_ultima_compra decimal, loja_mais_frequente text, loja_da_ultima_compra text);
